  ...
  data () {
    return {
      projects: [
        ...
        {name: 'Social Networking', description: ['A community-based application to facilitate and encourage dynamic event hosting by members in a way that makes it so much easier to meet likeminded people in your community in a fun environment'], list: ['Dinner Parties', 'Singles Events', 'Outdoor Activities', 'Group Travel']}
      ]
    }
  }
}
